...
# This function should be called with the path to your dataset
model, label_encoders, scaler = train_and_save_sleep_xgb_model('./Sleep_health_and_lifestyle_dataset.csv')
