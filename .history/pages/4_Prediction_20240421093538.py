...
def train_and_save_sleep_xgb_model(dataset_path):
    ...
    model = xgboost.XGBClassifier(objective='multi:softprob', num_class=4)  # Assuming 4 classes for the disorders
...
if model_type == "Skin Health Prediction":
    ...
    with st.status("Loading", expanded=True, state="running") as status:
        ...
        try:
            ...
            model, label_encoders, scaler = train_and_save_sleep_model("./Sleep_health_and_lifestyle_dataset.csv")
